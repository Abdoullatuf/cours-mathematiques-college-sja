...
\begin{exercisebox}{\faIcon{sort-numeric-down} Exercice 1 : Rang des chiffres \points{4}}
  ...
  \begin{enumerate}[label=\textcolor{primary}{\textbf{\alph*)}},leftmargin=*]
    \item Quel est le chiffre des centaines ? \ans{3} \points{1}
    \item Quel est le chiffre des dizaines de milliers ? \ans{5} \points{1}
    \item Quel est le \emph{nombre de milliers} dans ce nombre ? \ans{\num{7256}} \points{1}
    \item Donne la décomposition décimale de ce nombre : \points{1}
    \anslines[0.4cm]{2}{$7\times\num{1000000} + 2\times\num{100000} + 5\times\num{10000} + 6\times\num{1000} + 3\times\num{100} + 9\times\num{10} + 4$}
  \end{enumerate}
\end{exercisebox}
...
\begin{exercisebox}{\faIcon{spell-check} Exercice 2 : Écriture en lettres \points{4}}
  ...
  \begin{enumerate}[label=\textcolor{primary}{\textbf{\alph*)}},leftmargin=*]
    \item \num{1200} : \anslines[0.35cm]{1}{mille-deux-cents} \points{1}
    \item \num{5087} : \anslines[0.35cm]{2}{cinq-mille-quatre-vingt-sept} \points{1}
    \item \num{14680} : \anslines[0.35cm]{2}{quatorze-mille-six-cent-quatre-vingts} \points{1}
    \item \num{300092} : \anslines[0.35cm]{2}{trois-cent-mille-quatre-vingt-douze} \points{1}
  \end{enumerate}
\end{exercisebox}
...
\begin{exercisebox}{\faIcon{ruler-horizontal} Exercice 3 : Demi-droite graduée \points{5}}
  ...
  \begin{enumerate}[label=\textcolor{primary}{\textbf{\alph*)}},leftmargin=*]
    ...
    \anslines[0.3cm]{1}{L'unité de longueur est de 200 (chaque graduation principale correspond à 200 unités et chaque petite graduation 50)}

    \item Quelle est l'abscisse du point $A$ ? \ans{\num{1350}} \points{1}

    \item Quelle est l'abscisse du point $B$ ? \ans{\num{1750}} \points{1}

    \item Quelle est l'abscisse du point $C$ ? \ans{\num{2025}} \points{1}

    \item Place le point $E$ d'abscisse \num{2125} sur la demi-droite ci-dessus. \anslines[0.3cm]{1}{Point $E$ placé entre 2000 et 2200, plus proche de 2200} \points{1}
  \end{enumerate}
\end{exercisebox}
