% Contenu partagÃƒÂ© (ÃƒÂ©lÃƒÂ¨ve/corrigÃƒÂ©) Ã¢â‚¬â€ IParcours G2
% !TeX program = lualatex

% BarÃƒÂ¨me indicatif (ajustez si besoin)
\bareme{
  \exbadge{1}{5} \quad
  \exbadge{2}{4} \quad
  \exbadge{3}{3}
...
% =============================
% EXERCICE 1 Ã¢â‚¬â€ Cours et propriÃƒÂ©tÃƒÂ©s (8 pts)
% =============================
\begin{exercisebox}{\faIcon{book} Exercice 1 : Cours et propriÃƒÂ©tÃƒÂ©s \points{5}}
  \textbf{1.} Ãƒâ€°nonce le \textbf{thÃƒÂ©orÃƒÂ¨me de Pythagore}. \points{1}

  \anslines[0.5cm]{3}{\begin{minipage}{\linewidth}
    Dans un triangle rectangle, le carrÃƒÂ© de la longueur de l'hypotÃƒÂ©nuse est ÃƒÂ©gal ÃƒÂ  la somme des carrÃƒÂ©s des longueurs des deux autres cÃƒÂ´tÃƒÂ©s.
  \end{minipage}}

  \smallspace

  \textbf{2.} ComplÃƒÂ¨te chaque propriÃƒÂ©tÃƒÂ© avec lÃ¢â‚¬â„¢ÃƒÂ©galitÃƒÂ© de Pythagore correspondante. \points{2}
  ...
  \textbf{3.} Ãƒâ€°nonce la \textbf{rÃƒÂ©ciproque du thÃƒÂ©orÃƒÂ¨me de Pythagore}. \points{1}

  \anslines[0.5cm]{3}{\begin{minipage}{\linewidth}
    Si, dans un triangle, le carrÃƒÂ© de la longueur du plus grand cÃƒÂ´tÃƒÂ© est ÃƒÂ©gal ÃƒÂ  la somme des carrÃƒÂ©s des longueurs des deux autres cÃƒÂ´tÃƒÂ©s, alors ce triangle est rectangle (lÃ¢â‚¬â„¢angle droit est ÃƒÂ  lÃ¢â‚¬â„¢extrÃƒÂ©mitÃƒÂ© commune aux deux petits cÃƒÂ´tÃƒÂ©s).
  \end{minipage}}

  \smallspace

  \textbf{4.} ComplÃƒÂ¨te chaque propriÃƒÂ©tÃƒÂ© (utiliser la rÃƒÂ©ciproque). \points{1}
  \begin{enumerate}[label=\alph*)]
...
% =============================
% EXERCICE 2 Ã¢â‚¬â€ VÃƒÂ©rifier si un triangle est rectangle (4 pts)
% =============================
\begin{exercisebox}{\faIcon{check-double} Exercice 2 : Triangle rectangle ? \points{4}}
  \textbf{7.} Soit $BUT$ un triangle tel que $TU = \SI{5,1}{cm}$, $BU = \SI{7,9}{cm}$ et $BT = \SI{6}{cm}$. Ce triangle est-il rectangle ? Justifie ta rÃƒÂ©ponse. \points{2}
  ...
  \anslines[0.55cm]{6}{\begin{minipage}{\linewidth}
    ...
    Comme $62{,}41 \neq 62{,}01$, on nÃ¢â‚¬â„¢a pas lÃ¢â‚¬â„¢ÃƒÂ©galitÃƒÂ© de Pythagore. Donc le triangle $BUT$ nÃ¢â‚¬â„¢est \textbf{pas} rectangle.
  \end{minipage}}

  \smallspace

  \textbf{8.} Soit $CAR$ un triangle tel que $RA = \SI{3,3}{cm}$, $AC = \SI{5,6}{cm}$ et $RC = \SI{6,5}{cm}$. Ce triangle est-il rectangle ? Justifie ta rÃƒÂ©ponse. \points{2}

  \anslines[0.55cm]{6}{\begin{minipage}{\linewidth}
    $\max(RC, RA, AC) = RC$. On compare $RC^2$ et $RA^2 + AC^2$ :\\
    $RA^2 + AC^2 = 3{,}3^2 + 5{,}6^2 = 10{,}89 + 31{,}36 = 42{,}25$;\quad $RC^2 = 6{,}5^2 = 42{,}25$.\\
    Les deux quantitÃƒÂ©s sont ÃƒÂ©gales, donc par la rÃƒÂ©ciproque de Pythagore, $CAR$ est rectangle en $A$.
  \end{minipage}}
\end{exercisebox}
...
% =============================
% EXERCICE 3 Ã¢â‚¬â€ ProblÃƒÂ¨me (vie courante) : Table de chevet (3 pts)
% =============================
\begin{problembox}{\faIcon{cubes} Exercice 3 : La table de chevet \points{3}}
  \noindent\begin{minipage}[t]{0.55\linewidth}\vspace{0pt}
  Un designer a imaginÃƒÂ© une table de chevet en marbre (plateau) et mÃƒÂ©tal (structure). On modÃƒÂ©lise la structure ci-dessous. Les segments \([JL]\) et \([KI]\) sont \textbf{perpendiculaires} en \(M\).
  ...
  \begin{enumerate}[label=\arabic*.]
    ...
    \item En dÃƒÂ©duire si le montant \([JK]\) est vertical et si le plateau \([JI]\) est parallÃƒÂ¨le au sol. \points{1}
      ...
      Donc lÃ¢â‚¬â„¢angle \(\widehat{KJI}\) est droit: \(JK \perp JI\). Ainsi, \(JK\) est vertical et \(JI\) est horizontal (donc parallÃƒÂ¨le au sol).}}
  \end{enumerate}
\end{problembox}
