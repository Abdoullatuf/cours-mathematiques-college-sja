...
%\input{../../commun/preambule_commun_test}
...
% \input{chapitres/seq_04_distance_cercle_triangle} % Distance, cercle et triangles
...
% \input{chapitres/seq_08} % Opérations avec les nombres décimaux
% \input{chapitres/seq_09} % La médiatrice d'un segment
% \input{chapitres/seq_10} % La division
% \input{chapitres/seq_11} % Symétrie axiale
