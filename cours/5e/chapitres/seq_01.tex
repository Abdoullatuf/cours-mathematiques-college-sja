...
\begin{enumerate}[label=\alph*)]
\item Effectuer les calculs suivants avec la calculatrice :\\
\quad $A = 12 - 2 \times 4$ \qquad $B = 20 + 10 \div 2$ \qquad $C = 3 \times 6 - 20 \div 5$\\
Quelles opérations la calculatrice a-t-elle effectuées en premier ?
\item Recopier et compléter :\\
$\ll$ La \trous{6cm} et la \trous{6cm} sont prioritaires par rapport à \trous{8cm} et à \trous{6cm}. $\gg$
\end{enumerate}
\end{activitybox}
