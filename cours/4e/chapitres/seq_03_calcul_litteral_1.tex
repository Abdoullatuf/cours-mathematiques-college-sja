...
\begin{proprietebox}[Termes semblables]
	...
	\begin{itemize}
		...
		\item $2xy$ et $-7xy$ sont semblables (partie littérale : $xy$)
		\item $4x$ et $4y$ ne sont PAS semblables
		\item $3x^2$ et $3x$ ne sont PAS semblables
	\end{itemize}
\end{proprietebox}
...
\begin{examplebox}[Réduction complexe]
	...
	\textbf{Solution :}
	\begin{itemize}
		\item Termes en $a^2$ : $2a^2$ et $a^2$ → $(2 + 1)a^2 = 3a^2$
		\item Termes en $a$ : $3a$ et $-7a$ → $(3 - 7)a = -4a$
		\item Termes constants : $-5$ et $2$ → $-5 + 2 = -3$
		\item \textbf{Résultat :} $F = 3a^2 - 4a - 3$
	\end{itemize}
\end{examplebox}
